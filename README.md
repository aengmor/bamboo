...
姑且算是个基于 Django 构建的出土文献数字化平台，打算向著名的苏美尔语在线词典[ePSD2](https://oracc.museum.upenn.edu/epsd2/)那样，做成文字编、辞典和语料库联动的超级系统。

当然，水平所限，这个目标永远不能完成。

与DeepSeek V4 Flash 网页端共创。（说是共创，实则由于我零基础，基本都是D导手把手教我做的。）

已支持竹简释文的按篇管理、上古音注音、古文字字形图片对照、集释众包等功能。
>>>>>>> a01cc39667055d00726a31d24b3a91bc92a52b29
